...
Generate a complete, production-disciplined CRUD API using FastAPI with a strict layered architecture, SQLite database, and hybrid JWT authentication (short-lived access tokens + whitelisted refresh tokens).
